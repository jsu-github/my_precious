...
export default function AnalyticsPage({ entityFilter }: Props) {
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="font-headline italic text-4xl text-on-surface">Performance Analytics</h1>
        <p className="text-on-surface-variant mt-2 text-sm">
          Batch-level returns &amp; benchmarks ·{' '}
      ...
      <div className="glass-panel rounded-xl p-8 border border-outline-variant/20">
        <p className="text-on-surface-variant/60 text-sm">Phase 6 · Coming soon</p>
        <p className="text-on-surface-variant/40 text-xs mt-1">
          Market ticker · Batch P&amp;L table · ROI metrics · Locked asset indicators
        </p>
      </div>
    </div>
  );
